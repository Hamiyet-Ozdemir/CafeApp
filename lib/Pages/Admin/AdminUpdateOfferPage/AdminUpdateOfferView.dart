...
class AdminUpdateOfferState extends State<AdminUpdateOffer> {
  ...
  AdminUpdateOfferState(String cafeId) {
    this.cafeId = cafeId;
  }

  String cafeId;
  static String docId;
  static String setButton = "Yayınla";
...
static String cafeName="";
  ...
  static String descriptionHintText = "Ek Açıklama";
  static String picturePathHintText = "Kampanya Resmi";
                ...
                children: [
                  Row(
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          if(setButton=="Güncelle"){
                            AuthService().updateOffer(
                                docId,
                                cafeId,
                                offerTitle.text,
                                offerDetail.text,
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              color: Color(0xFFB6B7C8), fontSize: 16)),
                    ),
                  ),
                  //ilk textfield
