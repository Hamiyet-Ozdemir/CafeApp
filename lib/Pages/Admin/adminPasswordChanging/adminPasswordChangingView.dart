...
class adminPasswordChanging extends StatefulWidget {
  @override
  State<adminPasswordChanging> createState() => _adminPasswordChangingState();
} //view

class _adminPasswordChangingState extends State<adminPasswordChanging> {
