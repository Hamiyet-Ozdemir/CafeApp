                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      hintText: "örneğin: Çay Kampanyası",
                                      hintStyle: TextStyle(
                                          color: Color(0xFFB6B7C8),
                                          fontSize: 12)),
                                ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      hintText: "örneğin: 2 ile 8 arası çay %10 indirimli",
                                      hintStyle: TextStyle(
                                          color: Color(0xFFB6B7C8),
                                          fontSize: 12)),
                                ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      hintText: "örneğin: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                                      hintStyle: TextStyle(
                                          color: Color(0xFFB6B7C8),
                                          fontSize: 12)),
                                ),
