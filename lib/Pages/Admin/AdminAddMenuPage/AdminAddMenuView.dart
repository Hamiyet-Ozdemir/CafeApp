...
class AdminCafeMenu extends StatefulWidget {
  ...
  AdminCafeMenu(String url, String cafeId,String cafeName)
      : this.url = url,
        this.cafeId = cafeId,
        this.cafeName=cafeName;
        
  @override
  _AdminCafeMenuState createState() => _AdminCafeMenuState(url, cafeId,cafeName);
}

class _AdminCafeMenuState extends State<AdminCafeMenu> {
  Directory selectedDirectory;
  _AdminCafeMenuState(this.url, this.cafeId,this.cafeName);
