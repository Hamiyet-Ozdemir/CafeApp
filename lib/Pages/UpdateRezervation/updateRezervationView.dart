...
class updateRezervation extends StatefulWidget {
  @override
  State<updateRezervation> createState() => _updateRezervationState();
} //view

class _updateRezervationState extends State<updateRezervation> {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      hintText: "Cam Kenarı Ayırabilir Misiniz?",
                                      hintStyle: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 12)),
                                ),
